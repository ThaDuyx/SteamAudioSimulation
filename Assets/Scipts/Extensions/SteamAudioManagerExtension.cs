...
public static class SteamAudioManagerExtensions
{
    ...
    public static bool IsLastSOFA(this SteamAudioManager steamAudioManager) { return steamAudioManager.currentHRTF == 2; } // hardcoded as 2 for now - this is used for only rendering the far field sofa files
